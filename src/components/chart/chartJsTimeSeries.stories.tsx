...
import ChartJsTimeSeries from './chartJsTimeSeries'

export default {
  title: 'Rustic UI/Chart/Chart.js Time Series',
  component: ChartJsTimeSeries,
  tags: ['autodocs'],
  argTypes: {
    timeSeries: {
      control: 'array',
...
const chartLineColors = ['#648FFF', '#785EF0', '#DC267F', '#FE6100', '#FFB000']
...
export const CustomizChartColor = {
  args: { ...Default.args, chartLineColors, chartFillColors },
}
